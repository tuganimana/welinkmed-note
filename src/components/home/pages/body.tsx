...
export default function Body () {
  ...
  <div className="md:max-w-7xl mx-auto md:pl-24 md:pr-24 flex flex-wrap">
       <div className="w-ful md:w-1/2 p-4 md:p-4">
           <div className="text-center md:mt-16 py-24">
      ...
      <div className="md:pl-32 md:pr-32 bg-gray-200">
          ...
          <div key={index} className="w-full md:w-1/3 p-2" data-scrollreveal="enter top over 0.4s after 0.1s">
            <div className="wrapper antialiased text-gray-900">
              ...
              <div className="relative px-6 -mt-16  ">
                <div className="bg-white opacity-95  rounded-xl grid p-3 item-center text-center shadow-lg">
      ...
      <div className="bgImageWeb">
        <div className="md:pl-32 md:pr-32  bg-red-800 bg-opacity-70">
          <div className="md:max-w-7xl mx-auto grid gap-6 w-full pt-24 pb-24">
          ...
          <div className="flex flex-wrap">
            <div className="w-full md:w-1/2 p-2">
              <div className="p-6 grid gap-2 bg-gray-100 rounded">
                <span className="text-xl font-bold text-blue-400"><i className="fa fa-facebook mr-3 text-blue-800 rounded-xl  p-4 text-md"></i> We link Med</span>
                <span className="text-xl font-bold text-green-400"><i className="fa fa-phone mr-3  text-green-400 rounded-xl  p-4 text-md"></i> +1 234 568 434 542</span>
                <span className="text-xl font-bold text-blue-300"><i className="fa fa-twitter mr-3 text-blue-400 rounded-xl p-4 text-md"></i> We link Med</span>
                <span className="text-xl font-bold text-blue-300"><i className="fa fa-linkedin mr-3 text-blue-300 rounded-xl p-4 text-md"></i> We link Med</span>
              </div>
            </div>
            <div className="w-full md:w-1/2 p-2">
