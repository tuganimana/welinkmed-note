    ...
    <div className="flex flex-col w-full md:w-64 text-gray-700 bg-white text-gray-200 flex-shrink-0" x-data="{ open: false }">
      ...
      <hr className="text-2 text-gray-600 font-bold"/>
        <nav className="flex-grow w-full md:block px-4 pb-4 md:pb-0 md:overflow-y-auto py-2">
          <a className="block p-2 mt-2 text-md font-bold text-gray-600 border-blue-500 mt-4 rounded-lg  hover:shadow-lg bg-red-200  hover:bg-red-300 focus:bg-red-200 focus:text-white hover:text-white text-gray-200 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline" href="#">
