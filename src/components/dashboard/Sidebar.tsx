    ...
    <div className="flex flex-col w-full md:w-full text-gray-700 bg-green-400 text-gray-200 flex-shrink-0">
      ...
      <hr className="text-2 text-gray-600 font-bold"/>
       ...
       <a className="block p-2 mt-2 text-md font-bold text-gray-600 border-blue-500 rounded-lg hover:shadow-lg hover:bg-red-200 focus:bg-red-200 focus:text-white hover:text-white text-gray-200 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline" href="#">
            ...
            <a className="p-2 mt-2 text-md font-bold text-gray-600 border-blue-500 rounded-lg hover:shadow-lg hover:bg-red-200 focus:bg-red-200 focus:text-white hover:text-white text-gray-200 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline" href="#">
            <span className=" text-black bg-yellow-200 rounded-full p-3 inline-block"><IoIosPhotos /> </span>
