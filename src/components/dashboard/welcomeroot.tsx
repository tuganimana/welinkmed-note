      ...
      <div className="container p-4 md:mt-8">
        ...
        <div className="lg:inline-flex lg:flex-row lg:ml-auto lg:w-auto w-full lg:items-center items-start  flex flex-col lg:h-auto">
            ...
            <div className="mb-4 bg-white rounded-xl mx-2 ">
              ...
              <a href={frontEndPoints.ROOT_ADMINDETAILS}><div className="p-3 bg-green-200 text-gray-600 flex flex-wrap font-bold rounded-xl shadow">
                <div className="bg-white rounded-full h-8 w-8 items-center"><UserAddOutlined className="ml-2" /></div>
                <span className="inline-block mt-2 mx-3">Admin</span>
                </div>
              </a>
